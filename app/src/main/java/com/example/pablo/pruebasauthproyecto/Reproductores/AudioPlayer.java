...
public class AudioPlayer extends AppCompatActivity {
    ...
    private CancionArtistaHearTthis cancionArtistaHearTthis;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cancionArtistaHearTthis = (CancionArtistaHearTthis) intent.getExtras().getSerializable(CANCION);

        Log.d("DEPURACIÓN", "cancion ->" + cancionArtistaHearTthis.toString());

        url = cancionArtistaHearTthis.getStreamUrl();
        ...
        textViewFecha.setText(cancionArtistaHearTthis.getFecha());
        textViewGenero.setText(cancionArtistaHearTthis.getGenero());
        textViewTitulo.setText(cancionArtistaHearTthis.getTitulo());
